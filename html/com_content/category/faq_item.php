...
<div class="faq__item">
  <input class="faq__checkbox" type="checkbox" checked id="item--<?= $this->item->alias; ?>" name="item--<?= $this->item->alias; ?>" >


  <div class="faq__question">
    <label class="faq__label" for="item--<?= $this->item->alias; ?>">
  ...
  <div class="faq__answer">
    ...
    <?php  if (isset($images->image_intro) and !empty($images->image_intro)) : ?>
    	...
    	<div class="faq__image-wrapper img-intro-<?php echo htmlspecialchars($imgfloat); ?>">
    	<img class="faq__image"
